# Getting help with rmsssim

Thanks for using rmsssim. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/rmsssim/issues) to make sure the 
