...
This package only depends on [raster](https://cran.r-project.org/package=raster).
...
On Fedora, make sure to run `dnf install proj proj-epsg gdal gdal-devel` first. 
On other systems, change the commands accordingly.
